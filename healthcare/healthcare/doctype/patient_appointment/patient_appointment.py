...
from frappe.utils import flt, get_link_to_form, get_time, getdate, get_datetime, time_diff_in_hours, add_to_date
...
@frappe.whitelist()
def get_availability_data(date, practitioner, to_tz=None):
	"""
