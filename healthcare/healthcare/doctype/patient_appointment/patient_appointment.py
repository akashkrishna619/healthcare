...
from frappe.utils import flt, get_link_to_form, get_time, getdate, get_datetime, convert_utc_to_timezone
...
@frappe.whitelist()
def get_availability_data(date, practitioner, display_tz=None):
	"""
